  ...
  \resumeSubHeadingListStart
	...
	\resumeSingle{
		...
		\resumeSingleItem{
			...
			There is a demonstration bot available: (\url{https://medium.com/@yakubov.sha/reinforcement-learning-cryptocurrency-trading-bot-proof-of-concept-fda6b5c821a0}).
