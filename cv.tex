...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    ...
    \\
    Oceanographer with expertise in machine learning, AI application development, numerical modeling of the ocean, \\
    and software development.\\
    I am looking for opportunities to apply advances in modern machine learning, especially reinforcement learning, \\
    to the ocean numerical models.
\end{tabular*}
