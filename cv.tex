...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    ...
    Numerical modeler with experience in machine learning and data analysis.\\
\end{tabular*}
...
\section{Machine Learning projects}
  \resumeSubHeadingListStart
  	...
  	\resumeItem{Toy bridge builder}
  		{A reinforcement learning \href{https://github.com/limash/construction-unity-environments}{environment} implemented using Unity.
  		It shows the possibility of using reinforcement learning algorithms as constructors.}
    ...
    \resumeItem{Top 2\% solution in the Featured Simulation Kaggle Competition "Lux AI"}
        ...
        It consists of an \href{https://github.com/limash/lux-gym}{environment} and a \href{https://github.com/limash/lux-ai}{trainer}, which include custom training loops for imitation and reinforcement learning, and a custom buffer to store game experience.
  	...
  	\resumeItem{Implemented a policy gradient based reinforcement learning algorithm for a \href{https://github.com/limash/gym-goose}{custom environment}}
  	    {The implementation is close to \href{https://arxiv.org/abs/1802.01561}{IMPALA}.
  	     It includes a custom
  	    \href{https://github.com/limash/goose-agent/blob/main/tf_reinforcement_agents/policy_gradient.py}{training loop} of an off-policy actor-critic algorithm with n-step update, policy gradients correction, entropy, and other improvements.
    ...
    \resumeItem{Implemented a DQN based reinforcement learning algorithms}
        {The project inludes custom training loops \href{https://github.com/limash/tf-reinforcement-testcases/blob/master/tf_reinforcement_testcases/deep_q_learning.py}{implementation} of several reinforcement algorithms (TensorFlow): DQN, FixedDQN, DoubleDQN, DoubleDuelingDQN, categorical DQN.
        It uses \href{https://www.ray.io/}{RAY} to distribute calculations and \href{https://github.com/deepmind/reverb}{DM Reverb} as a data buffer to perform Prioritized Experience Replay.    
        It uses a \href{https://github.com/limash/tf-reinforcement-testcases/blob/b1d114437bde6f082657daf24eed66f1f79bac12/tf_reinforcement_testcases/models.py\#L64}{sparse MLP} as a function approximator.}
    
	\resumeItem{Conducted an optimization \href{https://github.com/limash/Alkalinity_in_the_Wadden_Sea}{study}}
	...
	\resumeItem{Conducted a signal processing \href{https://doi.org/10.3103/S1068373916110054}{study}}
		{It proposes the method to predict 'Freak waves' based on waves parameters.
		The study uses cluster analysis to categorize waves to groups and then uses Fourier and Wavelet analysis to study properties and features of these groups.}

  \resumeSubHeadingListEnd


%-----------EXPERIENCE-----------------
\section{Research, development and data analysis experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Research}
          {Studied biogeochemical interactions between the ocean and the atmosphere in the North Sea region.
           Published 4 peer-reviewed articles, 2 preprints, and 2 interactive jupyter notebook studies
           (\href{https://github.com/limash/Alkalinity_in_the_Wadden_Sea}{first},
            \href{https://github.com/limash/Carbon_dioxide_absorption_drivers}{second})).}
        \resumeItem{Development}
          {Built and optimized ocean ecosystem and biogeochemical models.}
        \resumeItem{Data analysis}
          {Processed and analyzed geospatial data using Pandas, Numpy, Matplotlib, etc.
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      	\resumeItem{Research}
      	  {Studied waves, Arctic ecosystems and biogeochemical processes.
      	   Published 5 peer-reviewed articles.}
        \resumeItem{Development}
          {Introduced the CMake build system and refactored Fortran90 code to modern object-oriented Fortran in multiple numerical projects.
           Introduced dynamic NetCDF i/o into several Fortran projects.
...
\resumeSubHeadingListStart
\item{
	\textbf{Languages}{: Python (Tensorflow, Keras, Numpy, Pandas), FORTRAN, MatLab, LaTeX}
	% \hfill
