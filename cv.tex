...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    ...
    Oceanographer with substantial experience in data analysis and machine learning.\\
\end{tabular*}
...
\section{Machine Learning projects}
  \resumeSubHeadingListStart
    \resumeItem{Top 2\% solution in the Featured Simulation Kaggle Competition "Lux AI"}
  	...
  	\resumeItem{Developed a policy gradient based reinforcement learning algorithm for a \href{https://github.com/limash/gym-goose}{custom environment}}
  	    {The implementation is close to \href{https://arxiv.org/abs/1802.01561}{IMPALA}.
  	     It includes a custom
  	    \href{https://github.com/limash/goose_agent/blob/main/tf_reinforcement_agents/policy_gradient.py}{training loop} of an off-policy actor-critic algorithm with n-step update, policy gradients correction, entropy, and other improvements.
    ...
    \resumeItem{Developed a DQN based reinforcement learning algorithms}
        {The project inludes custom training loops \href{https://github.com/limash/tf_reinforcement_testcases/blob/master/tf_reinforcement_testcases/deep_q_learning.py}{implementation} of several reinforcement algorithms (TensorFlow): DQN, FixedDQN, DoubleDQN, DoubleDuelingDQN, categorical DQN.
